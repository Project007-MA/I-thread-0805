...
plt.xlabel("Time (events index)",fontweight='bold')
plt.ylabel("CPU Usage (Normalized)",fontweight='bold')
plt.title("Legitimate and Anomalous CPU Usage",fontweight='bold')
plt.legend()
...
plt.xlabel("Time (events index)",fontweight='bold')
plt.ylabel("Memory Usage (Normalized)",fontweight='bold')
plt.title("Legitimate and Anomalous Memory Usage",fontweight='bold')
plt.legend()
plt.grid(True, linestyle="--", alpha=0.6)
plt.show()
